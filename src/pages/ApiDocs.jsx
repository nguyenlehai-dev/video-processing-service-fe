...
export default function ApiDocs() {
  ...
  const endpoints = [
    {
      ...
      params: [
        { name: 'video', type: 'File', desc: 'Video file to cut' },
  ...
  -F "end_time=00:00:30"`,
    ...
    },
    {
      ...
      params: [
        { name: 'videos', type: 'Array of Files', desc: 'Multiple video files to merge (order matters)' }
      ],
  ...
  -F "videos=@part2.mp4"`,
    ...
    },
    {
      ...
      params: [
        ...
        { name: 'audio', type: 'File', desc: 'Secondary audio file (.mp3, .wav)' },
  ...
  -F "replace=false"`,
    ...
    },
    {
      ...
      params: [
        { name: 'video', type: 'File', desc: 'Video file to crop' },
  ...
  -F "y=0"`,
    ...
    },
    {
      ...
      params: [
        { name: 'video', type: 'File', desc: 'Video file to extract audio from' },
  ...
  -F "format=mp3"`,
    ...
    },
    {
      ...
      params: [
        { name: 'video', type: 'File', desc: 'Video file' },
  ...
  -F "adjust_audio=true"`,
    ...
    },
    {
      ...
      params: [
        { name: 'video', type: 'File', desc: 'Video file to resize' },
